...
<div class="basis-60 shrink-0 h-[calc(100vh-64px)] p-4 pt-0 flex flex-col gap-4">
    <div class="h-1/2 flex flex-col ">
        ...
        <ul class="space-y-3 overflow-scroll  grow  p-3  bg-white rounded-xl shadow-md ">
            @foreach ($users as $user)
                <li class="flex items-center gap-3 hover:bg-slate-100 transition rounded-full p-1 cursor-pointer">
                    @if ($user->img_path)
                        <div>
